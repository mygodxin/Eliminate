...
using Spine.Unity;
using System;
public class SkinRewardWin : AppWindow
{
    public static string NAME = "SkinRewardWin";
    ...
    int _type;
    int skinIndex;
    public SkinRewardWin() : base("SkinRewardWin", "end")
    {
    }
    ...
    public override void RefreshUi()
    {
        ...
        this.skinIndex = (int)this.openData;
